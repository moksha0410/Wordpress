...
if ( !class_exists( '\\HelpieFaq\\Includes\\Repos\\Faq_Group' ) ) {
    class Faq_Group
    {
        ...
        public function modify_faq_group_items( $action, $postId, array $faq_group_items )
        {
            ...
            if ( $action == 'add' || !$faq_exists_in_group ) {
        ...
        {
            return;
            $settings_data = ( isset( $_REQUEST['faq_group_setting_fields_object'] ) ? json_decode( stripslashes( $_REQUEST['faq_group_setting_fields_object'] ), true ) : [] );
